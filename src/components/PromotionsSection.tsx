    ...
    <section className="py-16 bg-gradient-to-r from-accent to-orange-500 text-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <Icon name="Zap" className="mx-auto mb-6 animate-on-scroll" size={64} />
          <h2 className="text-3xl md:text-4xl font-bold mb-6 animate-on-scroll">Акционные предложения</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-white/10 border-white/20 text-white animate-on-scroll">
            ...
            <Card className="bg-white/10 border-white/20 text-white animate-on-scroll animate-on-scroll-delay-1">
              <CardContent className="p-6">
            ...
            <Card className="bg-white/10 border-white/20 text-white animate-on-scroll animate-on-scroll-delay-2">
              <CardContent className="p-6">
